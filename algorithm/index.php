        ...
        <ul class="timeline">
            ...
            <li>
                ...
                <div class="animation-chain overflow-hidden" data-animation="fadeInRight">
                    ...
                    <h4 class="animated" style="animation-delay: 0.1s;">Определение и анализ источников.</h4>
                </div>
            ...
            <li>
                ...
                <div class="animation-chain overflow-hidden" data-animation="fadeInLeft">
                    ...
                    <h4 class="animated" style="animation-delay: 0.1s;">Определение способов контроля.</h4>
                </div>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id error atque debitis tempora soluta, modi voluptatum sunt optio, ut quidem quam dolore. Unde minus quasi consequuntur consequatur, tempore repudiandae aperiam?</p>
            </li>
            <li>
                ...
                <div class="animation-chain overflow-hidden" data-animation="fadeInRight">
                    ...
                    <h4 class="animated" style="animation-delay: 0.1s;">Составление этапов обучения.</h4>
                </div>
            ...
            <li>
                ...
                <div class="animation-chain overflow-hidden" data-animation="fadeInLeft">
                    ...
                    <h4 class="animated" style="animation-delay: 0.1s;">Создание обстоятельств, обеспечивающих выполнение плана</h4>
                </div>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Id error atque debitis tempora soluta, modi voluptatum sunt optio, ut quidem quam dolore. Unde minus quasi consequuntur consequatur, tempore repudiandae aperiam?</p>
            </li>
            <li>
                ...
                <div class="animation-chain overflow-hidden" data-animation="fadeInRight">
                    ...
                    <h4 class="animated" style="animation-delay: 0.1s;">Запуск процесса обучения</h4>
