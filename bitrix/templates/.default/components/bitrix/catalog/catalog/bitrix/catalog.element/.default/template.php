        ...
        <div class="product-wrap">
            ...
            <div class="product-desc">
                ...
                <ul class="product-type-list">
                    <li class="product-type-list-item course"><?=$arResult['PROPERTIES']['CONTENT_TYPE']['VALUE']?></li>
...
<div class="product-gallery">
    <div class="w1000">
        <div class="cols">
            <div class="left-col">
                <h1 class="gallery-title">Скриншоты</h1>
                <div class="gallery">
                    <?
            ...
            <div class="left-col">
                                ...
                                if (isset($val) && $val)
                                {
                                    ...
                                    <div class="char-item">
                                        ...
                                        <div class="char-content">
                                            ...
                                            if(is_array($val))
                                            {
                                                echo preg_replace('~<a\b[^>]*+>|</a\b[^>]*+>~', '', implode(" / ", $val));
                                            }
                                            elseif($pid=="MANUAL")
                                            {
                ...
                ?>
                    <div class="product-detailed-content">
                        <h3>Содержание</h3>
                        <?=$arResult['DISPLAY_PROPERTIES']['CONTENT']['DISPLAY_VALUE']?>
                    </div>
                <?
                }
                ?>
