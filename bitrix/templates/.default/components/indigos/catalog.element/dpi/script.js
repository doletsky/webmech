    ...
    $(".product-detail-content-show a").click(function(event){
        ...
        if(parent.hasClass("littlebox")){
            ...
            setTimeout(function(){
                ...
                thislink.css('background','rgba(0, 0, 0, 0) url("/img/main/up.png") no-repeat scroll 0 0 / contain');
                setTimeout(function(){
            ...
            setTimeout(function(){
                ...
                thislink.css('background','rgba(0, 0, 0, 0) url("/img/main/down.png") no-repeat scroll 0 0 / contain');
                setTimeout(function(){
                    list.removeAttr("style");
                }, 50);
            },500);
