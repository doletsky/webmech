...
if(is_array(($arResult['PROPERTIES']['AGE']['VALUE']))){

    $strTmpAge=implode(",",$arResult['PROPERTIES']['AGE']['VALUE']);
    ...
    $arResult['PROPERTIES']['AGE']['VALUE']=explode(",", $strTmpAge);
    reset($arResult['PROPERTIES']['AGE']['VALUE']);
    $age=trim(current($arResult['PROPERTIES']['AGE']['VALUE']));
    end($arResult['PROPERTIES']['AGE']['VALUE']);
    $age.=" - ".trim(current($arResult['PROPERTIES']['AGE']['VALUE']));
    ...
    $arResult["CLASS"]["DISPLAY_VALUE"]=$age;
